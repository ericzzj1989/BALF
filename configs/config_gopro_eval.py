...
def parse_eval_config():
    ...
    parser.add_argument('--data_dir', type=str, default='data/gopro_exp2_with_hom_sharp_blur/',
...
def parse_single_image_config():
    parser = argparse.ArgumentParser(description='gopro evaluation detection extraction')

    parser.add_argument('--exper_name', type=str, required=True)
    parser.add_argument('--test_cfg_file', type=str, default='configs/detection_repeatability.yaml')
    parser.add_argument('--results_detection_dir', type=str, default='results_single_image',
                        help='Path for saving extraction results')
    ...
    parser.add_argument('--output_detection_img', type=bool, default=False,
                        help='Output the detection in the image.')
    parser.add_argument('--output_featuremap', type=bool, default=False,
                        help='Output the detection in the image.')
...
def parse_rel_blur_data_seq_config():
    parser = argparse.ArgumentParser(description='gopro evaluation detection extraction')

    parser.add_argument('--exper_name', type=str, required=True)
    parser.add_argument('--test_cfg_file', type=str, default='configs/detection_repeatability.yaml')
    parser.add_argument('--results_detection_dir', type=str, default='results_real_data',
                        help='Path for saving extraction results')
